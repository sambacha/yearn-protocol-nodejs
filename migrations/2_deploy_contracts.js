...
const StrategyCurveYBUSDVoterProxy = artifacts.require(
    "./strategies/StrategyCurveYBUSDVoterProxy.sol"
);
const StrategyCurveBTCVoterProxy = artifacts.require(
    "./strategies/StrategyCurveBTCVoterProxy.sol"
);
...
module.exports = async function (deployer, network, accounts) {
    ...
    const strategyCurveBUSD = await deployer.deploy(
        StrategyCurveYBUSDVoterProxy,
        CONTROLLER_ADDR
    );

    const strategyCurveBTC = await deployer.deploy(
